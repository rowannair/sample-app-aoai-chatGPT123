...
import logo_lallemand from "../../assets/logo_lallemand.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Welcome to Lallemand</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>I'm LalChat,your AI assistant</h2>
                            </Stack>
                        ) : (
